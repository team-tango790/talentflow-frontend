            ...
            <div style={{ border: "1.5px solid #2dd4bf", borderRadius: 14, overflow: "hidden" }}>
              ...
              <div style={{ padding: "18px 22px", background: "#fff" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 8 }}>
                  ...
                  <button style={{ display: "flex", alignItems: "center", gap: 6, background: "#f0f0e8", border: "1px solid #2dd4bf", borderRadius: 20, padding: "6px 14px", fontSize: 12, fontWeight: 600, cursor: "pointer", color: "#111", whiteSpace: "nowrap" }}>
                    View all <ArrowRight />
                  </button>
                </div>
