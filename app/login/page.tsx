// app/login/page.tsx
// NOTE: Update BASE_URL to your actual Render URL in .env.local as NEXT_PUBLIC_API_BASE_URL
// This file keeps the existing design but fixes the API endpoint and saves user data correctly.
"use client";
import Link from "next/link";
import { useState } from "react";
import { useRouter } from "next/navigation";

// ── Update this to your Render URL or set in .env.local as NEXT_PUBLIC_API_BASE_URL ──
