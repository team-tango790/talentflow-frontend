  ...
  return (
    <>
      <style>{`
        ...
        .sidebar-nav-link:hover { background: rgba(255,255,255,0.07); color: white; }
        .sidebar-nav-link.active { background: rgba(255,255,255,0.10); color: white; font-weight: 600; }
        ...
        .logout-btn:hover { background: rgba(231,76,60,0.12); color: #e74c3c; }
      `}</style>
      ...
      <aside style={{
        ...
        {/* Nav */}
        <nav className="sidebar-inner-nav" style={{ flex: 1, overflowY: "auto", padding: "16px 12px", display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ padding: "12px 16px", borderTop: "1px solid rgba(255,255,255,0.08)", flexShrink: 0, display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ overflow: "hidden", minWidth: 0 }}>
            <p style={{ fontSize: 13, fontWeight: 600, color: "white", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", fontFamily: "'DM Sans', sans-serif" }}>
              {userName}
            </p>
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", fontFamily: "'DM Sans', sans-serif" }}>
              {userTrack}
            </p>
          </div>
        </div>
